...
use Modules\Statistic\Console\Commands\ChangeDataStatistic;
...
class StatisticServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->commands(ChangeDataStatistic::class);
    ...
    public function registerSchedule(){
        $this->app->booted(function () {
            ...
            $schedule->command(ChangeDataStatistic::class)->everyMinute();
        });
    }
